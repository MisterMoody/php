      ...
      <div class="row">
        ...
        <nav id="sideNav" class="col-lg-3">
          ...
          <ul>
            ...
            <li>xxx</li>
            <li id=""><a id="fade" href="#xxx">xxx</a> &#47; <a id="fade" href="#xxx">xxx</a></li>
            <li id=""><a id="fade" href="#xxx">xxx</a> &#47; <a id="fade" href="#xxx">xxx</a></li>
            <li id=""><a id="fade" href="#xxx">xxx</a></li>
            <li></li>
          </ul>
        </nav>
        <!-- \End of SIDEBAR -->
        ...
        <div id="content" class="col-lg-9">
          ...
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam suscipit nunc a placerat tincidunt. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Nam id mauris commodo est vestibulum accumsan et at felis. Nam vel lectus eget magna dapibus ornare a ac dui. Mauris sodales aliquet diam in fringilla. Aliquam pellentesque gravida odio a facilisis. Quisque lacinia suscipit sem, quis mollis nibh iaculis a. Morbi libero ligula, varius ac sapien eu, gravida egestas mi. Duis risus nunc, commodo id facilisis vel, fringilla eu erat. Proin tempor, diam quis aliquet blandit, diam odio condimentum ex, et commodo velit turpis vitae elit. Pellentesque luctus condimentum est, quis sollicitudin est. Sed dui sem, luctus in enim vitae, faucibus egestas metus. Mauris suscipit imperdiet.</p>
